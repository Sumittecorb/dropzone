...
In order to proceed in our process, we would like you to perform a quick test and send it through to us:
...
Outputs:
Git repo or the code you wrote for this task
Live working demo
The code must be in Typescript.
If you intend to complete the test please inform us as well as let us know by when you think you will complete this test.